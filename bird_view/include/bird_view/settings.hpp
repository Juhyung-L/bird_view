...
{
    inline const std::filesystem::path YAML_DIR = "/home/dev_ws/src/bird_view/yaml";
...
{
    inline const std::string resolutions_file = "/home/dev_ws/src/bird_view/yaml/resolutions.yaml";
...
{
    inline const std::string projection_board_file = "/home/dev_ws/src/bird_view/yaml/project_board.yaml";
